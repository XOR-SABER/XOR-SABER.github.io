const categories = ["About Me", "Incoherent_Ramblings"]
...
'            <img src="/imgs/logo.svg" style="width: 12%;" class="">' + 
'            BetanVault' + 
...
'                    </li>' + 
'                    <li class="nav-item">' + 
'                        <a href="https://github.com/XOR-SABER" class="nav-link">' + 
'                            <i class="img-fluid bi bi-github"></i>' + 
'                        </a>' + 
'                    </li>' + 
'                </ul>' + 
'            </div>' + 
...
'';
function gen_nav() {
    document.getElementById("main_nav").innerHTML = main_nav;
}
gen_nav();